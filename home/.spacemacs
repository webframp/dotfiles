  ...
  (setq-default
   ...
   '(
     ...
     (go :variables
         ...
         gofmt-command "goreturns") ;; instead of default gofmt: go get -u github.com/sqs/goreturns
     haskell
     html
     javascript
     (markdown :variables
   ...
   dotspacemacs-additional-packages '(
                                      ...
                                      chef-mode deft org-kanban org-vcard direnv vdirel)
