  ...
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                      ag beacon conkeror-minor-mode crux moz textile-mode ssh-agency
                                         helm-rage monokai-theme gruvbox-theme dockerfile-mode ox-textile
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka";;"Hack"
                               :size 24
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
