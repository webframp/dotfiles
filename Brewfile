...
brew "d12frosted/emacs-plus/emacs-plus", args: ["HEAD", "with-emacs-27-branch", "with-jansson", "with-modern-icon", "with-no-titlebar", "without-spacemacs-icon"]
...
brew "webframp/tap/pass-age"
brew "webframp/tap/pass-update"
brew "webframp/tap/spotifyd"
