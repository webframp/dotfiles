# Generated by Powerlevel10k configuration wizard on 2022-04-13 at 19:07 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|bma|terraform|pulumi|terragrunt|serverless|sls|sfn|assume|ecs-deploy'
